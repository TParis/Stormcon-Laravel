<div class="provider-{{ $iter }}" id="provider-{{$iter}}">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            {{ Form::select('provider_' . $provider->index . '_name', $companies, $provider->{'provider_' . $provider->index . '_name'}, array('class' => 'form-control company-select',)) }}
        </div>
    </div>
    <div class="form-group row">
        {{ Form::label('provider_' . $provider->index . '_legal_name', 'Legal Name', array('class' => 'col-4 text-right control-label required-field')) }}
        <div class="col-8">
            {{ Form::text('provider_' . $provider->index . '_legal_name', $provider->{'provider_' . $provider->index . '_legal_name'}, array('class' => 'form-control',)) }}
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-8">
            {{ Form::text('provider_' . $provider->index . '_also_known_as', $provider->{'provider_' . $provider->index . '_also_known_as'}, array('class' => 'form-control',)) }}
        </div>
    </div>
    <div class="form-group row">
        {{ Form::label('provider_' . $provider->index . '_phone', 'Phone Number', array('class' => 'col-4 text-right control-label required-field')) }}
        <div class="col-8">
            {{ Form::text('provider_' . $provider->index . '_phone', $provider->{'provider_' . $provider->index . '_phone'}, array('class' => 'form-control',)) }}
        </div>
    </div>
    <div class="form-group row">
        {{ Form::label('provider_' . $provider->index . '_fax', 'Fax Number', array('class' => 'col-4 text-right control-label required-field')) }}
        <div class="col-8">
            {{ Form::text('provider_' . $provider->index . '_fax', $provider->{'provider_' . $provider->index . '_fax'}, array('class' => 'form-control',)) }}
        </div>
    </div>
    <div class="form-group row">
        {{ Form::label('provider_' . $provider->index . '_website', 'Website', array('class' => 'col-4 text-right control-label required-field')) }}
        <div class="col-8">
            {{ Form::text('provider_' . $provider->index . '_website', $provider->{'provider_' . $provider->index . '_website'}, array('class' => 'form-control',)) }}
        </div>
    </div>
    <div class="form-group row">
        {{ Form::label('provider_' . $provider->index . '_address', 'Address', array('class' => 'col-4 text-right control-label required-field')) }}
        <div class="col-8">
            {{ Form::text('provider_' . $provider->index . '_address', $provider->{'provider_' . $provider->index . '_address'}, array('class' => 'form-control',)) }}
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        {{ Form::label('provider_' . $provider->index . '_zipcode', 'Zip Code', array('class' => 'col-4 text-right control-label required-field')) }}
        <div class="col-8">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            {{ Form::text('provider_' . $provider->index . '_federal_tax_id', $provider->{'provider_' . $provider->index . '_federal_tax_id'}, array('class' => 'form-control',)) }}
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            {{ Form::text('provider_' . $provider->index . '_type', $provider->{'provider_' . $provider->index . '_type'}, array('class' => 'form-control',)) }}
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-8">
            {{ Form::number('provider_' . $provider->index . '_num_of_employees', $provider->{'provider_' . $provider->index . '_num_of_employees'}, array('class' => 'form-control',)) }}
        </div>
    </div>
    <div class="form-group row">
