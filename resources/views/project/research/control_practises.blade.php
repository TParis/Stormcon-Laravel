...
<table class="table table-bordered" id="control_practices_table">
    ...
    @for($i = 1; $i <= 4; $i++)
        <tr>
            ...
            <td>{{ Form::text("control_practice_{$i}_interim_or_permanent", $project->{"control_practice_{$i}_interim_or_permanent"} ?? '', ['class' => 'form-control', 'maxlength' => 9, 'readonly' => 'readonly']) }}</td>
        </tr>
    @endfor
    </tbody>
</table>
