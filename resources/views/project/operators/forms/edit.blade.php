<div class="operator-{{ $iter }}" id="operator-{{$iter}}">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            {{ Form::select('operator_' . $operator->index . '_name', $companies, $operator->{'operator_' . $operator->index . '_name'}, array('class' => 'form-control company-select', 'placeholder' => 'Gas R Us')) }}
        </div>
    </div>
    <div class="form-group row">
        {{ Form::label('operator_' . $operator->index . '_legal_name', 'Legal Name', array('class' => 'col-4 text-right control-label required-field')) }}
        <div class="col-8">
            {{ Form::text('operator_' . $operator->index . '_legal_name', $operator->{'operator_' . $operator->index . '_legal_name'}, array('class' => 'form-control', 'placeholder' => 'Gas R Us LLC')) }}
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-8">
            {{ Form::text('operator_' . $operator->index . '_also_known_as', $operator->{'operator_' . $operator->index . '_also_known_as'}, array('class' => 'form-control', 'placeholder' => 'Gas R Us')) }}
        </div>
    </div>
    <div class="form-group row">
        {{ Form::label('operator_' . $operator->index . '_phone', 'Phone Number', array('class' => 'col-4 text-right control-label required-field')) }}
        <div class="col-8">
            {{ Form::text('operator_' . $operator->index . '_phone', $operator->{'operator_' . $operator->index . '_phone'}, array('class' => 'form-control', 'placeholder' => '123-456-7890')) }}
        </div>
    </div>
    <div class="form-group row">
        {{ Form::label('operator_' . $operator->index . '_fax', 'Fax Number', array('class' => 'col-4 text-right control-label required-field')) }}
        <div class="col-8">
            {{ Form::text('operator_' . $operator->index . '_fax', $operator->{'operator_' . $operator->index . '_fax'}, array('class' => 'form-control', 'placeholder' => '123-456-7891')) }}
        </div>
    </div>
    <div class="form-group row">
        {{ Form::label('operator_' . $operator->index . '_website', 'Website', array('class' => 'col-4 text-right control-label required-field')) }}
        <div class="col-8">
            {{ Form::text('operator_' . $operator->index . '_website', $operator->{'operator_' . $operator->index . '_website'}, array('class' => 'form-control', 'placeholder' => 'https://www.website.com/')) }}
        </div>
    </div>
    <div class="form-group row">
        {{ Form::label('operator_' . $operator->index . '_address', 'Address', array('class' => 'col-4 text-right control-label required-field')) }}
        <div class="col-8">
            {{ Form::text('operator_' . $operator->index . '_address', $operator->{'operator_' . $operator->index . '_address'}, array('class' => 'form-control', 'placeholder' => '123 Main St East #211')) }}
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            {{ Form::text('operator_' . $operator->index . '_federal_tax_id', $operator->{'operator_' . $operator->index . '_federal_tax_id'}, array('class' => 'form-control', 'placeholder' => '25-1354867')) }}
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            {{ Form::text('operator_' . $operator->index . '_type', $operator->{'operator_' . $operator->index . '_type'}, array('class' => 'form-control', 'placeholder' => 'Limited Liability Corporation')) }}
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-8">
            {{ Form::number('operator_' . $operator->index . '_num_of_employees', $operator->{'operator_' . $operator->index . '_num_of_employees'}, array('class' => 'form-control', 'placeholder' => '5')) }}
        </div>
    </div>
    <div class="form-group row">
