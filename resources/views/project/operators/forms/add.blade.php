<div class="operator-{{ $iter }}" id="operator-{{$iter}}">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            {{ Form::text('operator_' . $iter . '_city', "", array('class' => 'form-control', 'placeholder' => 'Dallas')) }}
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            {{ Form::text('operator_' . $iter . '_zipcode', "", array('class' => 'form-control', 'placeholder' => '78123')) }}
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            {{ Form::text('operator_' . $iter . '_state_tax_id', "", array('class' => 'form-control', 'placeholder' => '1231564897')) }}
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            {{ Form::text('operator_' . $iter . '_division', "", array('class' => 'form-control', 'placeholder' => 'Residential')) }}
        </div>
    </div>
    <div class="form-group row">
        {{ Form::label('operator_' . $iter . '_sos', 'SOS Number', array('class' => 'col-4 text-right control-label required-field')) }}
        <div class="col-8">
            {{ Form::text('operator_' . $iter . '_sos', "", array('class' => 'form-control', 'placeholder' => '23123483')) }}
        </div>
    </div>
    <div class="form-group row">
        {{ Form::label('operator_' . $iter . '_cn', 'CN Number', array('class' => 'col-4 text-right control-label required-field')) }}
        <div class="col-8">
            {{ Form::text('operator_' . $iter . '_cn', "", array('class' => 'form-control', 'placeholder' => '1315547354')) }}
        </div>
    </div>
    <div class="form-group row">
        {{ Form::label('operator_' . $iter . '_sic', 'SIC Code', array('class' => 'col-4 text-right control-label required-field')) }}
        <div class="col-8">
            {{ Form::text('operator_' . $iter . '_sic', "", array('class' => 'form-control', 'placeholder' => 'B3B354ASD')) }}
        </div>
    </div>
</div>
