        ...
        <tr>
            <td class="border-top-0">
                ...
                <div class="container-fixed">
                    <select class="form-control w-25" onChange="window.location='/endangeredspecies/addCounty/' + this.value + '/{{ $county->id }}'">
    ...
    <table class="table table-light rounded">
        ...
        <tr>
            <td class="border-top-0">
                ...
                <div class="container-fixed">
                    <select class="form-control w-25" onChange="window.location='/companies/addCounty/' + this.value + '/{{ $county->id }}'">
