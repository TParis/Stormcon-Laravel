    ...
    <div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                @if (Auth::user()->hasAnyRole(['Admin', 'Sr Admin', 'Owner']))
                                    <a class="dropdown-item" href="{{ route("quicktext::index") }}">Quick Text</a>
                                @endif
                                @if (Auth::user()->hasAnyRole(['Admin', 'Sr Admin', 'Owner']))
        ...
        <footer>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-6 text-sm text-gray-500">
                        &copy; Copyright 2021.  All rights reserved except where expressly designated.<br>
                        Stormcon LLC, Dallas, Texas<br>
                        Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})
                    </div>
                    <div class="col-6 text-right text-sm text-gray-500">
